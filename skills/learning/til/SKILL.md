...
name: til
description: >-
  Captures learnings from any session — coding, research, or a /learn conversation — into an
  engaging TIL note in the Obsidian vault. Make sure to use this skill whenever the user runs /til,
  says "save what I learned", "create a TIL", "document this session", "write up what we built", or
  reaches the end of any learning or coding session where new things were learned. Also triggers at
  the end of a /learn session when the user says "done". Writes like telling a story to a friend —
  not a dry report.
user-invocable: true
...
want to read — not a dry changelog.
